package com.curso.CursoApi.Controllers;

import com.curso.CursoApi.Entities.Persona;
import com.curso.CursoApi.Services.PersonaService;
...
public class PersonaController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> upadte(@PathVariable Long id,@RequestBody Persona entity){
        try {
